...
Shader "Custom/Pixelate"
{
	Properties
	{
		...
		_PixelDensity( "PixelDensity", Float ) = 25
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 tex2DNode14 = tex2D( _MainTex, ( floor( ( texCoord30 * _PixelDensity ) ) / _PixelDensity ) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( input.ase_color * float4( tex2DNode14.rgb , 0.0 ) ).rgb;
				float Alpha = ( input.ase_color.a * tex2DNode14.a );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				surfaceDescription.Alpha = ( input.ase_color.a * tex2DNode14.a );
				#if defined( _ALPHATEST_ON )
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 texCoord30 = input.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode14 = tex2D( _MainTex, ( floor( ( texCoord30 * _PixelDensity ) ) / _PixelDensity ) );
...
WireConnection;16;1;14;5
WireConnection;36;0;15;4
WireConnection;36;1;14;4
WireConnection;18;2;16;0
WireConnection;18;3;36;0
ASEEND*/
//CHKSM=162455CCB42AE70129957B58F7F80A4D8360FB85